...
The activation-path experiment collapses accepted cumulative exports into a sorted, deduplicated process-level name set. Empty sets are retained honestly. Neither a repeated metric point nor its absence is converted into invocation counts, ordering, relationships, file-read claims, compliance, or outcomes.
